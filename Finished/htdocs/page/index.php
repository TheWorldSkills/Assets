            ...
            <div class="row">
                ...
                <div class="pull-right">
                    ...
                    <?php } ?>
                        ...
                        <?php 
                        if(isset($member) && $member->userid == 'admin'){
                         ?>
                        <li>
                            <a href="#" onclick="alert('관리자는 내 블로그 접근 금지')" title="내 블로그" >
                                내 블로그
                            </a>
                        </li>
                        <?php }else if($member){ ?>
                        <li>
                            <a href="/<?php echo $member->userid ?>" title="내 블로그" target="_blank">
                                내 블로그
                            </a>
                        </li>
                        <?php }else{ ?>
                            <li>
                            <a href="#" onclick="alert('로그인 후 사용가능 합니다.')" title="내 블로그" >
                                내 블로그
                            </a>
                        </li>
                        <?php } ?>
